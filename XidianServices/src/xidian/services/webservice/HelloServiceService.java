 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://server.services.xidian/", wsdlLocation = "http://127.0.0.1:8888/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://server.services.xidian/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://server.services.xidian/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.services.xidian/", "HelloServicePort"), HelloService.class, features);
    }
